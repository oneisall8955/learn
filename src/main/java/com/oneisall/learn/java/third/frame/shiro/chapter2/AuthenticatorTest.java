...
public class AuthenticatorTest {
    ...
    public void testAllSuccessfulStrategyWithSuccess() {
        login("classpath:shiro/chapter2/shiro-authenticator-all-success.ini");
    ...
    public void testAllSuccessfulStrategyWithFail() {
        login("classpath:shiro/chapter2/shiro-authenticator-all-fail.ini");
    }

    @Test
    public void testAtLeastOneSuccessfulStrategyWithSuccess() {
        login("classpath:shiro/chapter2/shiro-authenticator-atLeastOne-success.ini");
        Subject subject = SecurityUtils.getSubject();
